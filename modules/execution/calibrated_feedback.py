"""
Calibrated Execution Feedback Loop
Author: Erdinc Erdogan
Purpose: Implements logarithmic penalty scale for agent signal quality based on execution outcomes, with regime-aware slippage thresholds and EMA smoothing.
References:
- Execution Quality Feedback Loops
- Logarithmic Penalty Functions
- Regime-Adaptive Threshold Models
Usage:
    feedback = CalibratedFeedbackLoop(min_penalty_factor=0.5)
