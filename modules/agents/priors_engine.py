"""
Adaptive Bayesian Priors Engine - Dynamic Agent Weighting
Author: Erdinc Erdogan
Purpose: Replaces static agent priors with regime-conditional dynamic priors that adapt to market
conditions using Bayesian updating, enabling intelligent agent weight allocation.
References:
- Bayesian Inference and Prior Updating: P(Agent|Regime) ∝ P(Regime|Agent) × P(Agent)
