"""
Hardened Neural HMM with Safe Math Operations
Author: Erdinc Erdogan
Purpose: Production-stable Neural HMM implementation with numerically-safe operations for LSTM encoding and HMM state decoding.
References:
- Neural HMM (Tran et al., 2016)
- Numerical Stability in Deep Learning
- Safe Math Operations
Usage:
    model = NeuralHMMHardened(n_states=8, lstm_hidden=64)
